    ...
    <div className="max-w-7xl relative m-auto px-4 my-10 max-lg:p-6 py-20 flex flex-col">
      ...
      <div className="max-w-7xl w-full overflow-scroll">
        <table className="table mx-auto min-w-[1024px] border-[1px] border-red-50 text-center">
          ...
          <tbody>
            <tr>
              <th className="border-r-[1px] p-2 border-red-50" scope="row">
            ...
            <tr>
              ...
              <td className="border-r-[1px] py-2 border-red-50">
                €23 per month
              </td>
            </tr>
            <tr>
              <th className="border-r-[1px] py-2 border-red-50" scope="row">
        ...
        <table className="table  mx-auto min-w-[1024px] border-[1px] border-red-50 text-center">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="border-r-[1px] p-2 border-red-50">90 per month</td>
              <td className="border-r-[1px] p-2 border-red-50">
                2000 per month
              </td>
              <td className="border-r-[1px] p-2 border-red-50">
      ...
      <p className="my-6 text-center w-full text-gray-950 animate-pulse bg-green-500 py-2">
